...
import 'package:flutterBoilerplateWithbloc/core/validators/validator_email.dart';
import 'package:flutterBoilerplateWithbloc/core/validators/validator_password.dart';
...
class RegistrationFormBloc extends Object with EmailValidator, PasswordValidator implements BlocBase {
  ...
  //
  // Registration button
  /*Stream<bool> get registerValid => Stream.periodic(
                                      [email,
                                      password,
                                      confirmPassword,
                                      (e, p, c) => true]
