...
import 'package:flutterBoilerplateWithbloc/features/bloc/blocs/application_initialization/application_initialization_bloc.dart';
import 'package:flutterBoilerplateWithbloc/features/bloc/blocs/application_initialization/application_initialization_event.dart';
import 'package:flutterBoilerplateWithbloc/features/bloc/blocs/application_initialization/application_initialization_state.dart';
              ...
              builder: (BuildContext context, ApplicationInitializationState state){
                if (state.isInitialized){
                  ...
                  WidgetsBinding.instance.addPostFrameCallback((_){
                    Navigator.of(context).pushReplacementNamed('/enter_page');
                  });
                }
