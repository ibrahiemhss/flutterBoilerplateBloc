...
import 'package:flutterBoilerplateWithbloc/features/common_widgets/google_maps/page.dart';
...
class PlaceMarkerBodyState extends State<PlaceMarkerBody> {
  ...
  void _changePosition() {
    final Marker marker = _markers[selectedMarker];
    ...
    setState(() {
      _markers[selectedMarker] = marker.copyWith(
