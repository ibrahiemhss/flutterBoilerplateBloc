...
import 'nave_custom_painter.dart';
...
class MyNavigationBarState extends State<MyNavigationBar>
  ...
  @override
  void didUpdateWidget(MyNavigationBar oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: AppTheme.darkWhite.withOpacity(0.5),
          ...
          Positioned(
            ...
            child: CustomPaint(
              painter: NavCustomPainter(
                  _pos, _length, AppTheme.primary, Directionality.of(context)),
              child: Container(
                height: 85.0,
              ),
            ),
