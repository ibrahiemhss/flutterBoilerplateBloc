...
class DrCustomPaintedShape extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      child: Container(
        height: 250.0,
        child:
        Center(child: Text(AppLocalizations.of(context).app_name_txt,style: TextStyle(color: Colors.white,fontSize: 32),)),
...
class CurvePainter extends CustomPainter{
  ...
  paint.color = AppTheme.primaryDarkest;
